...
<div class="container">
    ...
    <div class="context">
        ...
        <form action="/2019210179/admin/updateNews">
            ...
            <label>作者: <input type="text" name="Author" value="${news.author}"></label><br>
            <label>新闻标题: <input type="text" name="Title" value="${news.title}"></label><br>
<%--            <span>新闻内容: </span><input type="text" name="Context" value="${news.context}"><br>--%>
            <div id="RTF"><p>${news.context}</p></div>
